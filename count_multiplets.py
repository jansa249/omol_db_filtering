...
OUTPUT_GRID = Path('./analysis_results/grid_multiplets.png')
MAX_MOLS_TO_PLOT = 6
MOLS_PER_ROW = 2
...
def analyze_smiles_fragments(csv_path):
    ...
    if not multiplets.empty:
        ...
        multiplets.to_csv('./analysis_results/multiplets.csv', sep=';', index=False)
        print("Detailed list saved to './analysis_results/multiplets.csv'")
